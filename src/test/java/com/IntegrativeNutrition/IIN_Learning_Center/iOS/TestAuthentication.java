...
import static com.IntegrativeNutrition.IIN_Learning_Center.Pages.iOS.Screens.LoginScreen;
import static com.IntegrativeNutrition.IIN_Learning_Center.Pages.iOS.Screens.ForgotPasswordScreen;
...
//    }
    ...
    @Test (groups = {"ios.regression", "ios.critical", "ios"}, priority = 6)
    public void signOut() {
        ...
        menuScreen.assertSignOutDeclined(true);
        menuScreen.attemptSignOut();
        menuScreen.assertSignOutAccepted(false);
    }
//
